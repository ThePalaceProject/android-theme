...
class ButtonsTextFragment : Fragment(R.layout.buttons_text) {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    this.b0 = view.findViewById(R.id.textSmall)
    this.b1 = view.findViewById(R.id.textSmallIconL)
    this.b2 = view.findViewById(R.id.textSmallIconR)
    this.b3 = view.findViewById(R.id.textMedium)
    this.b4 = view.findViewById(R.id.textMediumIconL)
    this.b5 = view.findViewById(R.id.textMediumIconR)
    this.b6 = view.findViewById(R.id.textLarge)
    this.b7 = view.findViewById(R.id.textLargeIconL)
    this.b8 = view.findViewById(R.id.textLargeIconR)
